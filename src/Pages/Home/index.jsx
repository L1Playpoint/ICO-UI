    ...
    <div className='home__container'>
      ...
      <div ref={AboutRef} className='home__container__about' data-aos="fade-up">
        ...
        <div className='home__container__about__content'>
          <div className='description' data-aos="fade-right">
            ...
            <p>
              is an{' '}
              <span className='highlight'>play-to-earn online prediction pool platform</span>{' '}
              ...
              Marketplace, a virtual Showcase vendor, a prediction
              Questionnaires hub, and variant prediction Pools.
              <br />
              &nbsp;
              <br />
        ...
        <div className='content'>
          ...
          <div className='content__description' data-aos="fade-left">
            ...
            <p>
              ...
              &nbsp;
              <br />
              PPT is a fungible token on the Binance Smart Chain blockchain,
              similar to any BEP20 Token or Currency. However, PPT can be used
              as a utility and a tradable token. This means it can be used
              inside Playpoint and can be withdrawn. By doing so, we can achieve
              trading of PPT on external or decentralized exchanges outside of
              our control.
            </p>
      ...
      <div ref={DocumentsRef} className='home__container__documents'>
        ...
        <div className='documents__links' data-aos="fade-left" data-aos-delay="600" data-aos-duration="500">
          ...
          <p>
            Here's the guide that informs our new players concisely about a complex mechanism of gameplay's and
            presents the playpoint's main philosophy on the matter. It is meant to
            help players understand an requirements of our platform, solve a problem, or make a
            decision.
          </p>
